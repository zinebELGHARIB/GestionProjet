...
use GesProjetBundle\Entity\Personne;
...
class PersonneController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $personnes = $em->getRepository('GesProjetBundle:Personne')->findAll();

       // return $this->render('personne/index.html.twig', array(
         //   'personnes' => $personnes,
       // ));
        $personne = new Personne();
        $form = $this->createForm('GesProjetBundle\Form\PersonneType', $personne);
    ...
    {
        $deleteForm = $this->createDeleteForm($personne);
        $editForm = $this->createForm('GesProjetBundle\Form\PersonneType', $personne);
